...
import { Mail, Twitter, Github, X } from "lucide-react";
        ...
        <div className="flex flex-col justify-between gap-4 ">
          ...
          <div className="flex items-center gap-3">
            <Avatar className="size-10">
              <AvatarImage
                src="https://pbs.twimg.com/profile_images/1934488067194146816/gbbJRKfx_400x400.jpg"
                alt="Oliyad Zelalem"
              />
            ...
            <div>
              <h1 className="text-s font-semibold tracking-tight first:mt-0">
                Oliyad Zelalem
              </h1>
